      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="mt-10 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <Link to="/dashboard" className="text-black hover:text-black mt-4 inline-block no-underline">View Inventory</Link>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <Link to="/services#maintenance" className="text-black hover:text-black mt-4 inline-block no-underline">Learn More</Link>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <Link to="/financing" className="text-black hover:text-blue-700 mt-4 inline-block no-underline">Apply for Financing</Link>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <Link to="/trade-in" className="text-black hover:text-blue-700 mt-4 inline-block no-underline">Get a Trade-in Estimate</Link>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <Link to="/test-drive" className="text-black hover:text-blue-700 mt-4 inline-block no-underline">Schedule a Test Drive</Link>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <Link to="/customization" className="text-black hover:text-blue-700 mt-4 inline-block no-underline">Explore Customization</Link>
          </div>
        </div>
      </div>
    </div>
