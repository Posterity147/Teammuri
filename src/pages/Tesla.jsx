...
const Tesla = () => {
  ...
  // Toggle liked state when heart icon is clicked
  const toggleLike = () => {
    setLiked(!liked);
  };
      ...
      <div>
        <div className="text-center">
          ...
          <p>
            ...
            - Iconic models: Model S, Model 3, Model X, Model Y, Cybertruck
          </p>
        </div>
      </div>
      <div id="grid">
        <div id="lambo">
          <Heart
            ...
            onClick={toggleLike} // Handle click event to toggle like
          />
